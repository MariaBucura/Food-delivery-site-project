...
<head>
   ...
   <div class="add-restaurant-form">
    ...
    <form method="POST" action="createres.php" enctype="multipart/form-data" class="add-restaurant-container">
          <label for="restaurant-name"><b>Restaurant name</b></label><br>
          <input class="form-input" type="text" placeholder="Enter name" name="restaurant-name" id="restaurant-name" required><br>
          <label for="restaurant-county"><b>County</b></label><br>
          <div class="dropdown">
            <input id="restaurant-county" name="restaurant-county" type="text" placeholder="Search counties..." class="dropdown-input" onkeyup="filterCounties(this.value)">
                <div class="dropdown-list" id="county-list">
                </div>
          </div><br>
          <label for="restaurant-city"><b>City</b></label><br>
          <input class="form-input" type="text" placeholder="Enter city" name="restaurant-city" id="restaurant-city" required><br>
          <label for="restaurant-street"><b>Street</b></label><br>
          <input class="form-input" type="text" placeholder="Enter street" name="restaurant-street" id="restaurant-street" required><br>
          <label for="restaurant-image"><b>Image</b></label><br>
          <input name="restaurant-image" id="restaurant-image" class="restaurant-img" type="file" name="image" accept="image/*"><br>
