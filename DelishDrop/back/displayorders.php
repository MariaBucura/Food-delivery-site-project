        ...
        <div class="order-section">
            ...
            if(mysqli_num_rows($orders) > 0){
                while($row = mysqli_fetch_assoc($orders)){
                    ...
                    <p>Date of purchase: <?php echo $row['date'];?></p>
                    <p>County: <?php echo $row['county'];?></p>
                    <p>City: <?php echo $row['city'];?></p>
                    <p>Street: <?php echo $row['street'];?></p>
                    <p>Order total: <?php echo number_format($row['total'], 2);?></p>
                    </div>
                    <?php
                    $order_id = $row['id'];
                    $sql_items = "SELECT * FROM orderItem WHERE orderID = '$order_id'";
                        ...
                        while($item_row = mysqli_fetch_assoc($order_items)){
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td><?php echo number_format($item_row['total'], 2); ?></td>
                                    </tr>
                            <?php
                        }
                    }
